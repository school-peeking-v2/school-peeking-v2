...
<html lang="ko">
    ...
    <body>
        ...
        <div class="invent-section text-center">
            ...
            <div class="container">
                <div class="col-sm">
                    <p class="inven-inst" id="inven-inst">곧 현재 모습과 아이템이 보입니다!</p>
                    <h3 class="inven-me-title">현재모습</h3>
                </div>
                <div class="inven-me">
                    <img class="item-img-me" src="images/character0.png" id="inven-me">
                </div>
                <div id="inven-list">
                    <div class="row">
                        ...
                        <div class="col-md" onclick='chgItem(0)'>
                            <div class="inven-item">
                                <img class="item-img" src="images/character1.png" id="img0">
                                <div class="inven-item-name">신입생2</div>
                            </div>
                        </div>
                        <div class="col-md" onclick='chgItem(0)'>
                            <div class="inven-item">
                                <img class="item-img" src="images/character2.png" id="img0">
                                <div class="inven-item-name">신입생3</div>
                            </div>
                        </div>
                        <div class="col-md" onclick='chgItem(0)'>
                            <div class="inven-item">
                                <img class="item-img" src="images/character3.png" id="img0">
                                <div class="inven-item-name">신입생1</div>
                            </div>
                        </div>
                        <div class="col-md" onclick='chgItem(0)'>
                            <div class="inven-item">
                                <img class="item-img" src="images/character4.png" id="img0">
                                <div class="inven-item-name">신입생2</div>
                            </div>
                        </div>
                        <div class="col-md" onclick='chgItem(0)'>
                            <div class="inven-item">
                                <img class="item-img" src="images/character5.png" id="img0">
                                <div class="inven-item-name">신입생3</div>
                            </div>
                        </div>
                    </div>
